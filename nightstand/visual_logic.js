...
registerOnClick('sphere_chrom', false, false, [0,1,2], function() {
  assignMat('legs', 'chrome');
}, function() {});
registerOnClick('sphere_paint_black', false, false, [0,1,2], function() {
  assignMat('legs', 'paint black');
}, function() {});
registerOnClick('sphere_paint_white', false, false, [0,1,2], function() {
  assignMat('legs', 'paint white');
}, function() {});

registerOnClick('plank_wood1', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'wood_original', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('plank_wood2', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'wood_original', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('plank_wood3', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'wood_original', 'wood_basecolor_3.jpg', function() {});
}, function() {});
...
registerOnClick('drawer', false, false, [0,1,2], function() {
  if (status2 == 'closed') {
    ...
    operateAnimation('PLAY', 'drawer', 0, 40, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, true);
